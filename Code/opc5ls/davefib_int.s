...
codestart:
        ...
        mov    r13,r0
        mov    r12,r0
        mov    r1,r0,0x08     # All bits zeroed except EI
...
fibEnd:
        # cause a SWI
        psr     psr, r0, 0x18  # set PSR bits        SWI_0, EI. Zero others  # EI is active low so disabling interrupts
        psr     psr, r0, 0x28  # set PSR bits SWI_1,        EI. Zero others
        psr     psr, r0, 0x38  # set PSR bits SWI_1, SWI_0, EI. Zero others
        halt    r0, r0, 0x999
